...
Vw_Sessions_Data.date_start_u AS date_start_u,
...
FROM
	Vw_Sessions_Data
	LEFT JOIN Vw_Loans_Issued_two on Vw_Loans_Issued_two.Session_Id = Vw_Sessions_Data.id
WHERE Vw_Loans_Issued_two.Is_First = 1

GROUP BY Vw_Sessions_Data.user_id
